    ...
    (set, get) => ({
      ...
      getConversations: async () => {
        ...
        try {
          ...
          console.log("Conversations Error:", error.response);
          console.log("Conversations Data:", error.response?.data);
          console.log("Conversations Status:", error.response?.status);
        } finally {
